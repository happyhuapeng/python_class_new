...
if __name__ == '__main__':
    ...
    while 1:
        ...
        iSpec2 = cv2.resize(iSpec, (600, 350), interpolation=cv2.INTER_CUBIC) # 插值
        iSpec2 = cv2.applyColorMap(iSpec2, cv2.COLORMAP_JET) # 设置伪彩色
        cv2.imshow('Spectrogram', iSpec2) # 显示
